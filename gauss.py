...
Original file is located at
    https://colab.research.google.com/drive/1ZvUREn1HoNVgsnBd8jzReMW9L58Ydupi
"""

# Código extraido de: http://pythonfiddle.com/gauss-jordan/
...
def generador(y,x):
    ...
    for i in range(y):
        for j in range(x):
            print()
            mat[i].append(error_test(input("a_" + str(i+1) + str(j+1) + " = "), 2))
    return mat
